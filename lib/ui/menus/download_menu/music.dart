...
class _AudioDownloadMenuState extends State<AudioDownloadMenu>
  ...
  // Audio Settings
  late AudioOnlyStream selectedAudio = widget.video.audioWithBestAacQuality ??
      widget.video.audioWithHighestQuality!;

  // Tags Controller
  late AudioTags mainTags =
      AudioTags.withStreamInfoItem(widget.video.toStreamInfoItem());
  ...
  void initState() {
    if (widget.video.segments?.isNotEmpty ?? false) {
      for (var segment in widget.video.segments!) {
        ...
        AudioTags audioTags =
            AudioTags.withStreamInfoItem(widget.video.toStreamInfoItem())
              ..titleController.text = MediaUtils.removeToxicSymbols(
                  title ?? widget.video.videoInfo.name ?? 'Unknown')
              ..artwork = previewUrl;
        segmentTracks.add(StreamSegmentTrack(
            audioTags: audioTags, segment: segment, enabled: true));
      }
    }
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            const Align(alignment: Alignment.center, child: BottomSheetPhill()),
            // Menu Title
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(Languages.of(context)!.labelMusic,
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding:
                              const EdgeInsets.only(top: 8, left: 12, right: 8),
                          child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: DropdownButton<String>(
                                      value: selectedAudio.formatName == "m4a"
                                          ? "AAC"
                                          : "OGG",
                                      iconSize: 18,
                                      borderRadius: BorderRadius.circular(20),
                                  ...
                                  SizedBox(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      items: selectedAudio.formatName == "m4a"
                                          ? List.generate(
                                              getSpecificAudioCodecList("m4a")
                                                  .length,
                                              (index) => DropdownMenuItem(
                                                    value:
                                                        "${getSpecificAudioCodecList("m4a")[index].averageBitrate}",
                                                    child: Text(
                                                        "${getSpecificAudioCodecList("m4a")[index].averageBitrate} Kbps/s"),
                                                  )).reversed.toList()
                                          : List.generate(
                                              getSpecificAudioCodecList("ogg")
                                                  .length,
                                              (index) => DropdownMenuItem(
                                                    value:
                                                        "${getSpecificAudioCodecList("ogg")[index].averageBitrate}",
                                                    child: Text(
                                                        "${getSpecificAudioCodecList("ogg")[index].averageBitrate} Kbps/s"),
                                                  )).reversed.toList(),
                                      onChanged: (String? value) {
                                        String codec =
                                            selectedAudio.formatName == "m4a"
                                                ? "m4a"
                                                : "ogg";
                                        int index =
                                            getSpecificAudioCodecList(codec)
                                                .indexWhere((element) =>
                                                    element.averageBitrate
                                                        .toString() ==
                                                    value);
                                        setState(() => selectedAudio =
                                            getSpecificAudioCodecList(
                                                codec)[index]);
                                      },
                                    ),
                                  ),
                                  const SizedBox(width: 8),
                                  InkWell(
                                    onTap: () => setState(() => mainTags =
                                        AudioTags.withStreamInfoItem(
                                            widget.video.toStreamInfoItem())),
                                    borderRadius: BorderRadius.circular(50),
                                    child: Ink(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(Languages.of(context)!.labelDownload,
                        style:
  ...
  Widget _menuBody() {
    return Column(
      ...
      children: [
        ...
        if (widget.video.segments?.isNotEmpty ?? false) _segmentsDownload(),
        const SizedBox(height: 4),
      ],
    );
  }
              ...
              child: Row(
                ...
                children: [
                  Icon(EvaIcons.editOutline,
                      color: Theme.of(context).primaryColor),
                  const SizedBox(width: 8),
                  Text(Languages.of(context)!.labelTagsEditor,
                  ...
                  GestureDetector(
                    child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(Languages.of(context)!.labelSearch,
                    ...
                    onTap: () async {
                      final MusicBrainzRecord? record =
                          await UiUtils.pushRouteAsync(
                              context,
                              MusicBrainzSearch(
                                  title: mainTags.titleController.text,
                                  artist: mainTags.artistController.text));
                      if (record == null) return;
                      setState(() {
                        mainTags = AudioTags.withMusicBrainzRecord(record)
                        ...
                        children: [
                          Expanded(
                            child: TextFieldTile(
                              ...
                              labelText:
                                  Languages.of(context)!.labelEditorTitle,
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: TextFieldTile(
                              ...
                              inputType: TextInputType.text,
                              labelText:
                                  Languages.of(context)!.labelEditorAlbum,
                          ...
                          Expanded(
                            child: TextFieldTile(
                              ...
                              inputType: TextInputType.text,
                              labelText:
                                  Languages.of(context)!.labelEditorArtist,
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: TextFieldTile(
                              ...
                              inputType: TextInputType.text,
                              labelText:
                                  Languages.of(context)!.labelEditorGenre,
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: TextFieldTile(
                                ...
                                labelText:
                                    Languages.of(context)!.labelEditorDisc,
                          ...
                          Expanded(
                            child: TextFieldTile(
                              ...
                              inputType: TextInputType.number,
                              labelText:
                                  Languages.of(context)!.labelEditorTrack,
              ...
              child: Row(
                ...
                children: [
                  Icon(EvaIcons.musicOutline,
                      color: Theme.of(context).primaryColor),
                  const SizedBox(width: 8),
                  Text(Languages.of(context)!.labelAudioFeatures,
                      style: subtitleTextStyle(context, bold: true)),
                  const Spacer(),
                  Icon(
                      showAudioFeatures ? Icons.expand_less : Icons.expand_more,
                      color: Theme.of(context).iconTheme.color),
                  const SizedBox(width: 12),
                ],
              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _audioFeatureSlider(
                            ...
                            onChanged: (double value) {
                              setState(
                                  () => filters.trebleGain = value.round());
                            },
                        ...
                        InkWell(
                          child: Ink(
                            ...
                            child: Row(
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(Languages.of(context)!.labelNormalizeAudio,
                                    style: TextStyle(
                                        fontSize: 16,
                                        color:
                                            Theme.of(context).iconTheme.color,
                          ...
                          onTap: () => setState(() =>
                              filters.normalizeAudio = !filters.normalizeAudio),
                        ),
                        InkWell(
                          onTap: () => setState(
                                        ...
                                        ? DropdownButtonHideUnderline(
                                            child: DropdownButton<String>(
                                              ...
                                              onChanged: (String? value) {
                                                ...
                                                if (value == 'AAC') {
                                                  task =
                                                      FFmpegTask.convertToAAC;
                                                } else if (value == 'OGG') {
                                                  task =
                                                      FFmpegTask.convertToOGG;
                                                } else {
                                                  task =
                                                      FFmpegTask.convertToMP3;
                                                }
                                                AppSettings.defaultFfmpegTask =
                                                    task;
                                                setState(() {});
                                              },
                                              value: AppSettings
  ...
  Widget _segmentsDownload() {
    return Column(
      children: [
        InkWell(
          onTap: () =>
              setState(() => showSegmentedDownload = !showSegmentedDownload),
          child: Padding(
            padding: const EdgeInsets.all(12),
            child: Ink(
              height: 32,
              child: Row(
                ...
                children: [
                  Icon(EvaIcons.listOutline,
                      color: Theme.of(context).primaryColor),
                  const SizedBox(width: 8),
                  Text(Languages.of(context)!.labelSegmentedDownload,
                      style: subtitleTextStyle(context, bold: true)),
                  const Spacer(),
                  Icon(
                      showSegmentedDownload
                          ? Icons.expand_less
                          : Icons.expand_more,
                      color: Theme.of(context).iconTheme.color),
                  const SizedBox(width: 12),
          ...
          child: showSegmentedDownload
              ? FadeInTransition(
                  ...
                  child: InkWell(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                    Languages.of(context)!
                                        .labelEnableSegmentedDownload,
                                    style:
                                        subtitleTextStyle(context, bold: true)),
                                const SizedBox(height: 8),
                                Text(
                                    Languages.of(context)!
                                        .labelEnableSegmentedDownloadDescription,
                                    style:
                                        smallTextStyle(context, opacity: 0.7)),
                              ],
                            ),
                          ),
                    ...
                    onTap: () =>
                        setState(() => segmentedDownload = !segmentedDownload),
                  ),
                )
              : const SizedBox.shrink(),
        ),
        AnimatedSize(
          curve: Curves.easeInOut,
          duration: const Duration(milliseconds: 300),
          child: segmentedDownload && showSegmentedDownload
              ? FadeInTransition(
                  delay: const Duration(milliseconds: 300),
                  duration: const Duration(milliseconds: 250),
                  child: Padding(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            Languages.of(context)!
                                                .labelCreateMusicPlaylist,
                                            style: subtitleTextStyle(context,
                                                bold: true)),
                                        Text(
                                            Languages.of(context)!
                                                .labelCreateMusicPlaylistDescription,
                        ...
                        InkWell(
                            ...
                            onTap: () async {
                              ...
                              for (int i = 0; i < segmentTracks.length; i++) {
                                if (!mounted) break;
                                String lastArtwork =
                                    segmentTracks[i].audioTags.artwork;
                                // ignore: prefer_typing_uninitialized_variables
                                var record;
                                try {
                                  record = await MusicBrainzAPI.getFirstRecord(
                                      segmentTracks[i]
                                          .audioTags
                                          .titleController
                                          .text);
                                ...
                                if (!mounted) break;
                                if (record != null) {
                                  segmentTracks[i].audioTags =
                                      await MusicBrainzAPI.getSongTags(
                                          MusicBrainzRecord.fromMap(record));
                                  if (segmentTracks[i].audioTags.artwork ==
                                      null) {
                                    segmentTracks[i].audioTags.artwork =
                                        lastArtwork;
                                  }
  ...
  Widget _segmentTile(int index) {
    ...
    return ListTile(
        onTap: () {
          setState(() =>
              segmentTracks[index].enabled = !segmentTracks[index].enabled);
        },
        title: Text(
        ...
        subtitle: Text(segment.audioTags.artistController.text,
            style: smallTextStyle(context, opacity: 0.7)),
        leading: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
                      ...
                      child: ClipRRect(
                        ...
                        child: ImageFade(
                          ...
                          image: isURL(segment.audioTags.artwork)
                              ? NetworkImage(segment.audioTags.artwork)
                                  as ImageProvider
        ...
        trailing: FlexiblePopupMenu(
          ...
          onItemTap: (String value) async {
            if (value == 'autoTag') {
              ...
              var record = await MusicBrainzAPI.getFirstRecord(
                  segmentTracks[index].audioTags.titleController.text);
              var parsedRecord = MusicBrainzRecord.fromMap(record);
              segmentTracks[index].audioTags =
                  await MusicBrainzAPI.getSongTags(parsedRecord);
