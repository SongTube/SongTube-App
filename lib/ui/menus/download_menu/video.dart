...
class VideoDownloadMenu extends StatefulWidget {
  ...
  const VideoDownloadMenu(
      {required this.video, required this.onBack, super.key});
...
class _VideoDownloadMenuState extends State<VideoDownloadMenu> {
  void onDownload(VideoOnlyStream stream) {
    final downloadInfo = DownloadInfo(
      ...
      audioStream:
          widget.video.getAudioStreamWithBestMatchForVideoStream(stream) ??
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(Languages.of(context)!.labelVideo,
                              ...
                              child: ClipRRect(
                                ...
                                child: ImageFade(
                                  ...
                                  placeholder: Container(
                                      color: Theme.of(context).cardColor),
                                  image: NetworkImage(
                                      widget.video.videoInfo.thumbnailUrl!),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
            ...
            SizedBox(
              ...
              child: FutureBuilder<int?>(
                  future: ExtractorHttpClient.getContentLength(
                      widget.video.audioWithHighestQuality!.url!),
                    ...
                    return GroupedListView<VideoOnlyStream, String>(
                        ...
                        itemBuilder: (context, VideoOnlyStream element) {
                          String framerateString =
                              element.resolution!.split("p").last;
                                      ...
                                      children: [
                                        Text(
                                            ...
                                            style: subtitleTextStyle(context,
                                                bold: true)),
                                        FutureBuilder<int?>(
                                            future: ExtractorHttpClient
                                                .getContentLength(element.url!),
            ...
            GestureDetector(
              onTap: () => selectedVideoStream != null
                  ? onDownload(selectedVideoStream!)
                  : null,
              child: AnimatedContainer(
