...
class DownloadContentMenu extends StatefulWidget {
  const DownloadContentMenu({required this.content, super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _optionTile(context,
                title: Languages.of(context)!.labelMusic,
                subtitle: Languages.of(context)!.labelMusicDownloadDescription,
                icon: Ionicons.musical_notes_outline, onTap: () {
                    ...
                    return AudioDownloadMenu(
                        ...
                        onBack: () {
                          ...
                          showModalBottomSheet(
                              ...
                              isScrollControlled: true,
                              backgroundColor: Colors.transparent,
                              builder: ((context) => DownloadContentMenu(
                                  content: widget.content)));
                        });
                  });
            }),
            _optionTile(context,
                title: Languages.of(context)!.labelVideo,
                subtitle: Languages.of(context)!.labelVideoDownloadDescription,
                icon: Ionicons.videocam_outline, onTap: () {
            ...
            _optionTile(context,
                title: Languages.of(context)!.labelInstant,
                subtitle: Languages.of(context)!.labelInstantDescription,
                icon: Ionicons.flash_outline,
                trailing: SizedBox(
                  height: 30,
                  child: DropdownButton<String>(
                    value: sharedPreferences
                            .getString('instant_download_format') ??
                        'AAC',
                    iconSize: 18,
                    borderRadius: BorderRadius.circular(20),
                    ...
                    onChanged: (String? value) async {
                      if (value == "AAC") {
                        await sharedPreferences.setString(
                            'instant_download_format', 'AAC');
                        setState(() {});
                      } else if (value == "OGG") {
                        await sharedPreferences.setString(
                            'instant_download_format', 'OGG');
                        setState(() {});
                      }
                    },
                  ),
              ...
              // Get default format
              final format =
                  sharedPreferences.getString('instant_download_format') ??
                      'AAC';
              // Build download
              final downloadInfo = DownloadInfo(
                ...
                tags: AudioTags.withStreamInfoItem(
                    widget.content.videoDetails!.toStreamInfoItem()),
              );
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle,
                      style: smallTextStyle(context, opacity: 0.8), maxLines: 3)
                ],
              ),
            ),
            if (onConfigure != null)
