                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: palette?.dominant?.withOpacity(0.9) ?? Colors.white,
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: tinyTextStyle(context).copyWith(
                                        ...
                                        color: palette?.text.withOpacity(0.9) ?? Colors.white)
                                    ),
                                    Text(
                                      ...
                                      overflow: TextOverflow.fade,
                                      softWrap: false,
                                      style: tinyTextStyle(context).copyWith(color: (palette?.text.withOpacity(0.8) ?? Colors.white))
                                    ),
                                  ],
                                ),
                              ),
                              const SizedBox(width: 16),
                              Icon(Iconsax.music_playlist, color: palette?.text.withOpacity(0.8) ?? Colors.white, size: 16)
                            ],
                          ),
                        ),
                      ),
