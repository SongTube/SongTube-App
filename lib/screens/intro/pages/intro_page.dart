...
class IntroPage extends StatefulWidget {
  const IntroPage({required this.onNextPage, Key? key}) : super(key: key);
          ...
          children: [
                        ...
                        RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text:
                                      "${Languages.of(context)!.labelPoweredBy}\n",
                                ),
                                TextSpan(
            ...
            RichText(
              ...
              text: TextSpan(children: [
                TextSpan(
                    text:
                        "${Languages.of(context)!.labelAppWelcome.toLowerCase()}\n",
            ...
            ShowUpTransition(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Text(Languages.of(context)!.labelGetStarted,
                      style: GoogleFonts.poppins(
                          fontSize: 16,
